...
tests = [
   ...
   },
   {
      ...
      "params": [["WTH8GC13uCZbP44HzMLV6zPZGwVQ8Nt4Kji8PapsPiNq1BK153XTX"]]
   },
   {
   ...
   },
   {
      ...
      "params": ["temp","2022-3-24T00:00:00",10]
   },
   {
   ...
   },
   {
      ...
      "params": [{"operations":[["transfer", {"from":"temp", "to":"null", "ammount":"1.000 WORTH"}]]}]
   },
...
#   },
   ...
   },
   {
      ...
      "params": ["temp",["WTH8GC13uCZbP44HzMLV6zPZGwVQ8Nt4Kji8PapsPiNq1BK153XTX"]]
   },
   {
...
#   },
   ...
   },
   {
      ...
      "params": ["2022-3-24T00:00:00", "2017-3-24T00:00:00", 10]
   },
   {
   ...
   },
   {
      ...
      "params": [60, "2022-3-24T00:00:00", "2017-3-24T00:00:00", ]
   },
   {
   ...
   },
   {
      ...
      "params": {"keys":["WTH8GC13uCZbP44HzMLV6zPZGwVQ8Nt4Kji8PapsPiNq1BK153XTX"]}
   },
   {
...
#   },
   ...
   },
   {
      ...
      "params": {"start":"2022-3-24T00:00:00", "end":"2017-3-24T00:00:00", "limit":10}
   },
   {
...
#   },
   ...
   {
      "method": "database_api.list_wbd_conversion_requests",
      "params": {"start":["",0], "limit":10, "order":"by_account"}
   },
   {
      "method": "database_api.find_wbd_conversion_requests",
      "params": {"account":"temp"}
   },
   {
   ...
   {
      "method": "database_api.list_wmt_token_emissions",
      "params": {"limit": 100, "order": "by_symbol_time", "start": []}
   },
   {  "method": "database_api.find_wmt_token_emissions",
      "params": {"asset_symbol": {"nai":"@@100000006", "decimals": 3}}
   }
   {
      "method": "database_api.list_wmt_contributions",
      "params": {"limit": 100, "order": "by_symbol_contributor", "start": []}
   },
   {
      "method": "database_api.find_wmt_contributions",
...
def main():
   if len( sys.argv ) == 1:
      url = "https://api.wortheum.news/"
   elif len( sys.argv ) == 2:
      url = sys.argv[1]
   else:
      exit( "Usage: api_error_smoketest.py <worth_api_endpoint>" )
