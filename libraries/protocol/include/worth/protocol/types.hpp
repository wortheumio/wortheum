...
#include <worth/protocol/fixed_string.hpp>
...
namespace worth {
   ...
   namespace protocol {
      ...
      #define WORTH_INIT_PUBLIC_KEY (worth::protocol::public_key_type(WORTH_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const worth::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  worth::protocol::public_key_type& vo );
    void to_variant( const worth::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, worth::protocol::extended_public_key_type& vo );
    void to_variant( const worth::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, worth::protocol::extended_private_key_type& vo );
}

FC_REFLECT( worth::protocol::public_key_type, (key_data) )
FC_REFLECT( worth::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( worth::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( worth::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( worth::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( worth::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( worth::protocol::share_type )

FC_REFLECT( worth::void_t, )
