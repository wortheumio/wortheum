...
#include <worth/protocol/legacy_asset.hpp>
...
namespace worth { namespace protocol {
   ...
   /** Allows to store all WMT tokens being allowed to use during voting process.
    *  Maps asset symbol (WMT) to the vote info.
    *  @see WMT spec for details: https://github.com/worthit/wmt-whitepaper/blob/master/wmt-manual/manual.md
    */
   struct allowed_vote_assets
   {
      ...
      void validate() const
      {
         FC_ASSERT(votable_assets.size() <= WMT_MAX_VOTABLE_ASSETS, "Too much votable assets specified");
         FC_ASSERT(is_allowed(WORTH_SYMBOL) == false,
            "WORTH can not be explicitly specified as one of allowed_vote_assets");
      }
    ...
    *  The percent_worth_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      asset             max_accepted_payout    = asset( 1000000000, WBD_SYMBOL );       /// WBD value of the maximum payout this post will receive
      uint16_t          percent_worth_dollars  = WORTH_100_PERCENT; /// the percent of Worth Dollars to key, unkept amounts will be received as Worth Power
    ...
    * @ingroup operations
    *
    * @brief Transfers WORTH from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             wbd_amount = asset( 0, WBD_SYMBOL );
      asset             worth_amount = asset( 0, WORTH_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      uint32_t          escrow_id = 30;
      asset             wbd_amount = asset( 0, WBD_SYMBOL ); ///< the amount of wbd to release
      asset             worth_amount = asset( 0, WORTH_SYMBOL ); ///< the amount of worth to release
   ...
   /**
    *  This operation converts liquid token (WORTH or liquid WMT) into VFS (Vesting Fund Shares,
    *  VESTS or vesting WMT) at the current exchange rate. With this operation it is possible to
   ...
   struct transfer_to_vesting_operation : public base_operation
   {
      ...
      asset             amount;  ///< must be WORTH or liquid variant of WMT
   ...
   struct legacy_chain_properties
   {
       ...
       */
      legacy_worth_asset account_creation_fee = legacy_worth_asset::from_amount( WORTH_MIN_ACCOUNT_CREATION_FEE );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = WORTH_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          wbd_interest_rate  = WORTH_DEFAULT_WBD_INTEREST_RATE;
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= WORTH_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= WORTH_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( wbd_interest_rate >= 0 );
         FC_ASSERT( wbd_interest_rate <= WORTH_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, WORTH_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between worth and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between WORTH and WBD,
    *  The funds are deposited after WORTH_CONVERSION_DELAY
    */
...
FC_REFLECT( worth::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( worth::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( worth::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( worth::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( worth::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( worth::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( worth::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( worth::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( worth::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( worth::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( worth::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( worth::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( worth::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (wbd_interest_rate)
          )

FC_REFLECT_TYPENAME( worth::protocol::pow2_work )
FC_REFLECT( worth::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( worth::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( worth::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( worth::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( worth::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( worth::protocol::account_update2_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( worth::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( worth::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( worth::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( worth::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( worth::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( worth::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( worth::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( worth::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( worth::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( worth::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( worth::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( worth::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( worth::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( worth::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( worth::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( worth::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( worth::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( worth::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( worth::protocol::comment_payout_beneficiaries, (beneficiaries) )

#ifdef WORTHEUM_ENABLE_WMT
FC_REFLECT( worth::protocol::votable_asset_info_v1, (max_accepted_payout)(allow_curation_rewards) )
FC_REFLECT( worth::protocol::allowed_vote_assets, (votable_assets) )
#endif

FC_REFLECT_TYPENAME( worth::protocol::comment_options_extension )
FC_REFLECT( worth::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_worth_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( worth::protocol::escrow_transfer_operation, (from)(to)(wbd_amount)(worth_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( worth::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( worth::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( worth::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(wbd_amount)(worth_amount) );
FC_REFLECT( worth::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( worth::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( worth::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( worth::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( worth::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( worth::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( worth::protocol::claim_reward_balance_operation, (account)(reward_worth)(reward_wbd)(reward_vests) )
#ifdef WORTHEUM_ENABLE_WMT
FC_REFLECT( worth::protocol::claim_reward_balance2_operation, (account)(extensions)(reward_tokens) )
#endif
FC_REFLECT( worth::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
