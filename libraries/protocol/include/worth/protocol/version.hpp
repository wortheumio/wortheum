...
/*
 * This class represents the basic versioning scheme of the Wortheum blockchain.
...
{
   class variant;
   void to_variant( const worth::protocol::version& v, variant& var );
   void from_variant( const variant& var, worth::protocol::version& v );

   void to_variant( const worth::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, worth::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( worth::protocol::version, (v_num) )
FC_REFLECT_DERIVED( worth::protocol::hardfork_version, (worth::protocol::version), )

FC_REFLECT( worth::protocol::hardfork_version_vote, (hf_version)(hf_time) )
