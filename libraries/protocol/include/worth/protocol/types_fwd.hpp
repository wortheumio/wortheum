...
template< typename Stream, typename Storage >
inline void unpack( Stream& s, worth::protocol::fixed_string_impl< Storage >& u, uint32_t depth = 0 );

template< typename Stream >
inline void pack( Stream& s, const worth::protocol::asset_symbol_type& sym );
template< typename Stream >
inline void unpack( Stream& s, worth::protocol::asset_symbol_type& sym, uint32_t depth = 0 );

template< typename Stream >
inline void pack( Stream& s, const worth::protocol::legacy_worth_asset_symbol_type& sym );
template< typename Stream >
inline void unpack( Stream& s, worth::protocol::legacy_worth_asset_symbol_type& sym, uint32_t depth = 0 );
...
inline void to_variant( const worth::protocol::fixed_string_impl< Storage >& s, fc::variant& v );
template< typename Storage >
inline void from_variant( const variant& v, worth::protocol::fixed_string_impl< Storage >& s );

inline void to_variant( const worth::protocol::asset_symbol_type& sym, fc::variant& v );
