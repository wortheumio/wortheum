...
struct create_proposal_operation : public base_operation
{
   ...
   /// Amount of WBDs to be daily paid to the `receiver` account.
   asset daily_pay;
...
FC_REFLECT( worth::protocol::create_proposal_operation, (creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink)(extensions) )
FC_REFLECT( worth::protocol::update_proposal_votes_operation, (voter)(proposal_ids)(approve)(extensions) )
FC_REFLECT( worth::protocol::remove_proposal_operation, (proposal_owner)(proposal_ids)(extensions) )

FC_REFLECT(worth::protocol::proposal_pay_operation, (receiver)(payment)(trx_id)(op_in_trx))
