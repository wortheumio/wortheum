...
FC_REFLECT_TYPENAME( worth::protocol::block_header_extensions )

FC_REFLECT( worth::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( worth::protocol::signed_block_header, (worth::protocol::block_header), (witness_signature) )
