...
using fc::ecc::canonical_signature_type;
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = WORTH_MAX_SIG_CHECK_DEPTH,
         uint32_t max_membership = WORTH_MAX_AUTHORITY_MEMBERSHIP,
         uint32_t max_account_auths = WORTH_MAX_SIG_CHECK_ACCOUNTS,
...
FC_REFLECT( worth::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( worth::protocol::signed_transaction, (worth::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( worth::protocol::annotated_signed_transaction, (worth::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
