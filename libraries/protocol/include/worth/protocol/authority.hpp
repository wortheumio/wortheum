 ...
 * - Length is between (inclusive) WORTH_MIN_ACCOUNT_NAME_LENGTH and WORTH_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace worth::protocol


FC_REFLECT_TYPENAME( worth::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( worth::protocol::authority::key_authority_map)
FC_REFLECT( worth::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( worth::protocol::authority::classification, (owner)(active)(key)(posting) )
