...
namespace worth { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), wbd_payout(s), worth_payout(st), vesting_payout(v){}
   ...
   {
      interest_operation( const string& o = "", const asset& i = asset(0,WBD_SYMBOL) )
         :owner(o),interest(i){}
   ...
   struct comment_benefactor_reward_operation : public virtual_operation
   {
      ...
      comment_benefactor_reward_operation( const account_name_type& b, const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         : benefactor( b ), author( a ), permlink( p ), wbd_payout( s ), worth_payout( st ), vesting_payout( v ) {}
   ...
   struct wps_fund_operation : public virtual_operation
   {
      wps_fund_operation() {}
      wps_fund_operation( const asset& v ) : additional_funds( v ) {}
...
FC_REFLECT( worth::protocol::author_reward_operation, (author)(permlink)(wbd_payout)(worth_payout)(vesting_payout) )
FC_REFLECT( worth::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( worth::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( worth::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( worth::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( worth::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( worth::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( worth::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( worth::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( worth::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( worth::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( worth::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( worth::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( worth::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(wbd_payout)(worth_payout)(vesting_payout) )
FC_REFLECT( worth::protocol::producer_reward_operation, (producer)(vesting_shares) )
FC_REFLECT( worth::protocol::clear_null_account_balance_operation, (total_cleared) )
FC_REFLECT( worth::protocol::wps_fund_operation, (additional_funds) )
