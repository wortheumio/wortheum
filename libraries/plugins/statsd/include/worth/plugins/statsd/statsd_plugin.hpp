...
#define WORTH_STATSD_PLUGIN_NAME "statsd"

namespace worth { namespace plugins { namespace statsd {
...
class statsd_plugin : public appbase::plugin< statsd_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WORTH_STATSD_PLUGIN_NAME; return name; }
