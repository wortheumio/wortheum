#pragma once
#include <worth/plugins/statsd/statsd_plugin.hpp>
...
using worth::plugins::statsd::statsd_plugin;
...
if( worth::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   worth::plugins::statsd::util::get_statsd().increment( \
...
if( worth::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   worth::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( worth::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   worth::plugins::statsd::util::get_statsd().count(     \
...
if( worth::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   worth::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< worth::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( worth::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = worth::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, worth::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( worth::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   worth::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      worth::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
