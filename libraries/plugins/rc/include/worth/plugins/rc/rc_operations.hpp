...
WORTH_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_to_pool_operation );
WORTH_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_drc_from_pool_operation );

} } } // worth::plugins::rc

FC_REFLECT( worth::plugins::rc::delegate_to_pool_operation,
   (from_account)
   (to_pool)
   (amount)
   )
FC_REFLECT( worth::plugins::rc::delegate_drc_from_pool_operation,
   (from_pool)
   (to_account)
   (mana_change)
   (drc_max_mana)
...
WORTH_DECLARE_OPERATION_TYPE( worth::plugins::rc::rc_plugin_operation )
FC_REFLECT_TYPENAME( worth::plugins::rc::rc_plugin_operation )
