...
struct operation_exec_info
{
   ...
   int64_t wmt_setup_operation_exec_time                       = 0;
   int64_t wmt_setup_emissions_operation_exec_time             = 0;
   int64_t wmt_set_setup_parameters_operation_exec_time        = 0;
   int64_t wmt_set_runtime_parameters_operation_exec_time      = 0;
   int64_t wmt_create_operation_exec_time                      = 0;
   int64_t wmt_contribute_operation_exec_time                  = 0;
#endif
...
FC_REFLECT( worth::plugins::rc::state_object_size_info,
   ( authority_base_size )
...
FC_REFLECT( worth::plugins::rc::operation_exec_info,
   ...
   ( wmt_setup_operation_exec_time )
   ( wmt_setup_emissions_operation_exec_time )
   ( wmt_set_setup_parameters_operation_exec_time )
   ( wmt_set_runtime_parameters_operation_exec_time )
   ( wmt_create_operation_exec_time )
   ( wmt_contribute_operation_exec_time )
#endif
