...
void to_variant( const worth::plugins::condenser_api::legacy_block_header_extensions&, fc::variant& );
void from_variant( const fc::variant&, worth::plugins::condenser_api::legacy_block_header_extensions& );

}

FC_REFLECT( worth::plugins::condenser_api::legacy_signed_transaction,
            (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions)(signatures)(transaction_id)(block_num)(transaction_num) )

FC_REFLECT( worth::plugins::condenser_api::legacy_signed_block,
