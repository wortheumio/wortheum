...
#include <worth/plugins/database_api/database_api.hpp>
#include <worth/plugins/block_api/block_api.hpp>
#include <worth/plugins/account_history_api/account_history_api.hpp>
#include <worth/plugins/account_by_key_api/account_by_key_api.hpp>
#include <worth/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <worth/plugins/tags_api/tags_api.hpp>
#include <worth/plugins/follow_api/follow_api.hpp>
#include <worth/plugins/reputation_api/reputation_api.hpp>
#include <worth/plugins/market_history_api/market_history_api.hpp>
#include <worth/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      wbd_balance( legacy_asset::from_asset( a.wbd_balance ) ),
      wbd_seconds( a.wbd_seconds ),
      wbd_seconds_last_update( a.wbd_seconds_last_update ),
      wbd_last_interest_payment( a.wbd_last_interest_payment ),
      savings_wbd_balance( legacy_asset::from_asset( a.savings_wbd_balance ) ),
      savings_wbd_seconds( a.savings_wbd_seconds ),
      savings_wbd_seconds_last_update( a.savings_wbd_seconds_last_update ),
      savings_wbd_last_interest_payment( a.savings_wbd_last_interest_payment ),
      savings_withdraw_requests( a.savings_withdraw_requests ),
      reward_wbd_balance( legacy_asset::from_asset( a.reward_wbd_balance ) ),
      reward_worth_balance( legacy_asset::from_asset( a.reward_worth_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_worth( legacy_asset::from_asset( a.reward_vesting_worth ) ),
   ...
   legacy_asset      wbd_balance;
   uint128_t         wbd_seconds;
   time_point_sec    wbd_seconds_last_update;
   time_point_sec    wbd_last_interest_payment;

   legacy_asset      savings_wbd_balance;
   uint128_t         savings_wbd_seconds;
   time_point_sec    savings_wbd_seconds_last_update;
   time_point_sec    savings_wbd_last_interest_payment;

   uint8_t           savings_withdraw_requests = 0;

   legacy_asset      reward_wbd_balance;
   legacy_asset      reward_worth_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_worth;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting worth
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_worth_dollars( c.percent_worth_dollars ),
   ...
   uint16_t          percent_worth_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      init_wbd_supply( legacy_asset::from_asset( o.init_wbd_supply ) ),
      current_wbd_supply( legacy_asset::from_asset( o.current_wbd_supply ) ),
      confidential_wbd_supply( legacy_asset::from_asset( o.confidential_wbd_supply ) ),
      total_vesting_fund_worth( legacy_asset::from_asset( o.total_vesting_fund_worth ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_worth( legacy_asset::from_asset( o.total_reward_fund_worth ) ),
      ...
      pending_rewarded_vesting_worth( legacy_asset::from_asset( o.pending_rewarded_vesting_worth ) ),
      wbd_interest_rate( o.wbd_interest_rate ),
      wbd_print_rate( o.wbd_print_rate ),
      ...
      wbd_stop_percent( o.wbd_stop_percent ),
      wbd_start_percent( o.wbd_start_percent )
   {}
   ...
   legacy_asset      init_wbd_supply;
   legacy_asset      current_wbd_supply;
   legacy_asset      confidential_wbd_supply;
   legacy_asset      total_vesting_fund_worth;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_worth;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_worth;
...
struct api_witness_object
{
   ...
   api_witness_object( const database_api::api_witness_object& w ) :
      ...
      props( w.props ),
      wbd_exchange_rate( w.wbd_exchange_rate ),
      last_wbd_exchange_update( w.last_wbd_exchange_update ),
      votes( w.votes ),
   ...
   legacy_price            wbd_exchange_rate;
   ...
   time_point_sec          hardfork_time_vote = WORTH_GENESIS_TIME;
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = WORTH_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = WORTH_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = WORTH_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = WORTH_HARDFORK_REQUIRED_WITNESSES;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      wbd_balance( legacy_asset::from_asset( e.wbd_balance ) ),
      worth_balance( legacy_asset::from_asset( e.worth_balance ) ),
...
struct discussion : public api_comment_object
{
   ...
   string                        root_title;
   legacy_asset                  pending_payout_value; ///< wbd
   legacy_asset                  total_pending_payout_value; ///< wbd including replies
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), worth_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string worth_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      worth_volume( legacy_asset::from_asset( t.worth_volume ) ),
      wbd_volume( legacy_asset::from_asset( t.wbd_volume ) )
   {}
   ...
   legacy_asset   worth_volume;
   legacy_asset   wbd_volume;
};
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      worth_volume( legacy_asset::from_asset( v.worth_volume ) ),
      wbd_volume( legacy_asset::from_asset( v.wbd_volume ) )
   {}
...
FC_REFLECT( worth::plugins::condenser_api::discussion_index,
...
FC_REFLECT( worth::plugins::condenser_api::api_account_object,
             ...
             (balance)
             (savings_balance)
             (wbd_balance)(wbd_seconds)(wbd_seconds_last_update)(wbd_last_interest_payment)
             (savings_wbd_balance)(savings_wbd_seconds)(savings_wbd_seconds_last_update)(savings_wbd_last_interest_payment)(savings_withdraw_requests)
             (reward_wbd_balance)(reward_worth_balance)(reward_vesting_balance)(reward_vesting_worth)
...
FC_REFLECT_DERIVED( worth::plugins::condenser_api::extended_account, (worth::plugins::condenser_api::api_account_object),
...
FC_REFLECT( worth::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_worth_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( worth::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(init_wbd_supply)(current_wbd_supply)(confidential_wbd_supply)
            (total_vesting_fund_worth)(total_vesting_shares)
            (total_reward_fund_worth)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_worth)
            (wbd_interest_rate)(wbd_print_rate)
            ...
            (delegation_return_period)(reverse_auction_seconds)(wbd_stop_percent)(wbd_start_percent) )

FC_REFLECT( worth::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
             ...
             (props)
             (wbd_exchange_rate)(last_wbd_exchange_update)
             (last_work)
             (running_version)
...
FC_REFLECT( worth::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( worth::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( worth::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( worth::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (wbd_balance)(worth_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( worth::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( worth::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( worth::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( worth::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT( worth::plugins::condenser_api::api_proposal_object,
             (id)(proposal_id)(creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink)(total_votes) )

FC_REFLECT_DERIVED( worth::plugins::condenser_api::discussion, (worth::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( worth::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( worth::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( worth::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( worth::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( worth::plugins::condenser_api::get_version_return,
            (blockchain_version)(worth_revision)(fc_revision) )

FC_REFLECT( worth::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( worth::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( worth::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( worth::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(worth_volume)(wbd_volume) )

FC_REFLECT( worth::plugins::condenser_api::volume,
            (worth_volume)(wbd_volume) )

FC_REFLECT( worth::plugins::condenser_api::order,
            (order_price)(real_price)(worth)(wbd)(created) )

FC_REFLECT( worth::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( worth::plugins::condenser_api::market_trade,
