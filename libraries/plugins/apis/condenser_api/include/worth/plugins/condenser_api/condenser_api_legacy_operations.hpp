...
#include <worth/plugins/condenser_api/condenser_api_legacy_asset.hpp>
...
namespace worth { namespace plugins { namespace condenser_api {
   ...
   struct api_chain_properties
   {
      ...
      api_chain_properties( const chain::chain_properties& c ) :
         ...
         wbd_interest_rate( c.wbd_interest_rate ),
      ...
      operator legacy_chain_properties() const
      {
         ...
         props.account_creation_fee = legacy_worth_asset::from_asset( asset( account_creation_fee ) );
         props.maximum_block_size = maximum_block_size;
         props.wbd_interest_rate = wbd_interest_rate;
         return props;
      }
      ...
      int32_t        account_subsidy_budget = WORTH_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
      uint32_t       account_subsidy_decay = WORTH_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
   };
   ...
   struct legacy_comment_options_operation
   {
      ...
      legacy_comment_options_operation( const comment_options_operation& op ) :
         ...
         percent_worth_dollars( op.percent_worth_dollars ),
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_worth_dollars = percent_worth_dollars;
      ...
      uint16_t          percent_worth_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         wbd_amount( legacy_asset::from_asset( op.wbd_amount ) ),
         worth_amount( legacy_asset::from_asset( op.worth_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
      ...
      operator escrow_transfer_operation()const
      {
         ...
         op.wbd_amount = wbd_amount;
         op.worth_amount = worth_amount;
         op.fee = fee;
      ...
      legacy_asset      wbd_amount;
      legacy_asset      worth_amount;
      legacy_asset      fee;
   ...
   struct legacy_pow2_operation
   {
         ...
         new_owner_key( op.new_owner_key )
      {
         ...
         props.wbd_interest_rate = op.props.wbd_interest_rate;
      }
      ...
      operator pow2_operation()const
      {
         ...
         op.props.account_creation_fee = legacy_worth_asset::from_asset( asset( props.account_creation_fee ) );
         op.props.maximum_block_size = props.maximum_block_size;
         op.props.wbd_interest_rate = props.wbd_interest_rate;
         return op;
      }
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_worth( legacy_asset::from_asset( op.reward_worth ) ),
         reward_wbd( legacy_asset::from_asset( op.reward_wbd ) ),
      ...
      operator claim_reward_balance_operation()const
      {
         ...
         op.account = account;
         op.reward_worth = reward_worth;
         op.reward_wbd = reward_wbd;
         op.reward_vests = reward_vests;
         return op;
      }

      account_name_type account;
      legacy_asset      reward_worth;
      legacy_asset      reward_wbd;
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         author( op.author ),
         permlink( op.permlink ),
         wbd_payout( legacy_asset::from_asset( op.wbd_payout ) ),
         worth_payout( legacy_asset::from_asset( op.worth_payout ) ),
      ...
      operator author_reward_operation()const
      {
         ...
         op.author = author;
         op.permlink = permlink;
         op.wbd_payout = wbd_payout;
         op.worth_payout = worth_payout;
      ...
      account_name_type author;
      string            permlink;
      legacy_asset      wbd_payout;
      legacy_asset      worth_payout;
   ...
   struct legacy_wps_fund_operation
   {
      legacy_wps_fund_operation() {}
      legacy_wps_fund_operation( const wps_fund_operation& op ) :
         additional_funds( legacy_asset::from_asset( op.additional_funds ) )
      {}

      operator wps_fund_operation()const
      {
         wps_fund_operation op;
   ...
   struct legacy_operation_conversion_visitor
   {
      ...
      bool operator()( const wps_fund_operation& op )const
      {
         l_op = legacy_wps_fund_operation( op );
         return true;
      }

      // Should only be WMT ops
      template< typename T >
...
struct convert_from_legacy_operation_visitor
{
   ...
   operation operator()( const legacy_wps_fund_operation& op )const
   {
      return operation( wps_fund_operation( op ) );
   }
...
void to_variant( const worth::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, worth::plugins::condenser_api::legacy_operation& );

void to_variant( const worth::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
void from_variant( const fc::variant&, worth::plugins::condenser_api::legacy_comment_options_extensions& );

void to_variant( const worth::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
void from_variant( const fc::variant&, worth::plugins::condenser_api::legacy_pow2_work& );
...
FC_REFLECT( worth::plugins::condenser_api::api_chain_properties,
            (account_creation_fee)(maximum_block_size)(wbd_interest_rate)(account_subsidy_budget)(account_subsidy_decay)
          )

FC_REFLECT( worth::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( worth::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( worth::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( worth::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( worth::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( worth::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( worth::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( worth::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( worth::plugins::condenser_api::legacy_transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( worth::plugins::condenser_api::legacy_withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( worth::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( worth::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( worth::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( worth::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_worth_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( worth::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(wbd_amount)(worth_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( worth::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(wbd_amount)(worth_amount) );
FC_REFLECT( worth::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
FC_REFLECT( worth::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_worth)(reward_wbd)(reward_vests) )
FC_REFLECT( worth::plugins::condenser_api::legacy_delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
FC_REFLECT( worth::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(wbd_payout)(worth_payout)(vesting_payout) )
FC_REFLECT( worth::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( worth::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( worth::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( worth::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( worth::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( worth::plugins::condenser_api::legacy_fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( worth::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( worth::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( worth::plugins::condenser_api::legacy_return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( worth::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(wbd_payout)(worth_payout)(vesting_payout) )
FC_REFLECT( worth::plugins::condenser_api::legacy_producer_reward_operation, (producer)(vesting_shares) )
FC_REFLECT( worth::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )
FC_REFLECT( worth::plugins::condenser_api::legacy_proposal_pay_operation, (receiver)(payment)(trx_id)(op_in_trx) )
FC_REFLECT( worth::plugins::condenser_api::legacy_wps_fund_operation, (additional_funds) )
FC_REFLECT( worth::plugins::condenser_api::legacy_create_proposal_operation, (creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink) )

FC_REFLECT_TYPENAME( worth::plugins::condenser_api::legacy_operation )
