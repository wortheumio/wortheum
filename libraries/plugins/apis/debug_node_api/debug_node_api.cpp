#include <worth/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <worth/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > WORTH_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( WORTH_DEBUG_NODE_API_PLUGIN_NAME );
}
