   ...
   class network_broadcast_api_impl
   {
      public:
         network_broadcast_api_impl() :
            _p2p( appbase::app().get_plugin< worth::plugins::p2p::p2p_plugin >() ),
         ...
         worth::plugins::p2p::p2p_plugin&                      _p2p;
...
{
   JSON_RPC_REGISTER_API( WORTH_NETWORK_BROADCAST_API_PLUGIN_NAME );
}
