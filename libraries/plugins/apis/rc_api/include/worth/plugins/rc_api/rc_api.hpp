...
FC_REFLECT( worth::plugins::rc::get_resource_params_return,
   (resource_names)
   (resource_params)
   (size_info)
   )

FC_REFLECT( worth::plugins::rc::resource_pool_api_object,
   (pool)
   )

FC_REFLECT( worth::plugins::rc::get_resource_pool_return,
   (resource_pool)
   )

FC_REFLECT( worth::plugins::rc::rc_account_api_object,
   (account)
   (rc_manabar)
...
FC_REFLECT( worth::plugins::rc::find_rc_accounts_args,
   (accounts)
   )

FC_REFLECT( worth::plugins::rc::find_rc_accounts_return,
   (rc_accounts)
   )
