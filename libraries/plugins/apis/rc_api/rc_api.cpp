#include <worth/plugins/rc_api/rc_api_plugin.hpp>
#include <worth/plugins/rc_api/rc_api.hpp>
...
{
   public:
      rc_api_impl() : _db( appbase::app().get_plugin< worth::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( WORTH_RC_API_PLUGIN_NAME );
}
