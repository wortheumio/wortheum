...
namespace worth { namespace plugins { namespace account_history {
...
struct api_operation_object
{
   ...
   {
      op = fc::raw::unpack_from_buffer< worth::protocol::operation >( op_obj.serialized_op );
   }

   worth::protocol::transaction_id_type trx_id;
   uint32_t                               block = 0;
   uint32_t                               trx_in_block = 0;
   uint32_t                               op_in_trx = 0;
   uint32_t                               virtual_op = 0;
   fc::time_point_sec                     timestamp;
   worth::protocol::operation             op;
...
{
   worth::protocol::transaction_id_type id;
};

typedef worth::protocol::annotated_signed_transaction get_transaction_return;


struct get_account_history_args
{
   worth::protocol::account_name_type   account;
   uint64_t                               start = -1;
   uint32_t                               limit = 1000;
};
...
} } } // worth::plugins::account_history

FC_REFLECT( worth::plugins::account_history::api_operation_object,
   (trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(op) )

FC_REFLECT( worth::plugins::account_history::get_ops_in_block_args,
   (block_num)(only_virtual) )

FC_REFLECT( worth::plugins::account_history::get_ops_in_block_return,
   (ops) )

FC_REFLECT( worth::plugins::account_history::get_transaction_args,
   (id) )

FC_REFLECT( worth::plugins::account_history::get_account_history_args,
   (account)(start)(limit) )

FC_REFLECT( worth::plugins::account_history::get_account_history_return,
   (history) )

FC_REFLECT( worth::plugins::account_history::enum_virtual_ops_args,
   (block_range_begin)(block_range_end) )

FC_REFLECT( worth::plugins::account_history::enum_virtual_ops_return,
