...
{
   public:
      abstract_account_history_api_impl() : _db( appbase::app().get_plugin< worth::plugins::chain::chain_plugin >().db() ) {}
...
class account_history_api_rocksdb_impl : public abstract_account_history_api_impl
{
   public:
      account_history_api_rocksdb_impl() :
         abstract_account_history_api_impl(), _dataSource( appbase::app().get_plugin< worth::plugins::account_history_rocksdb::account_history_rocksdb_plugin >() ) {}
      ~account_history_api_rocksdb_impl() {}
...
{
   auto ah_cb = appbase::app().find_plugin< worth::plugins::account_history::account_history_plugin >();
   auto ah_rocks = appbase::app().find_plugin< worth::plugins::account_history_rocksdb::account_history_rocksdb_plugin >();
   ...
   JSON_RPC_REGISTER_API( WORTH_ACCOUNT_HISTORY_API_PLUGIN_NAME );
}
