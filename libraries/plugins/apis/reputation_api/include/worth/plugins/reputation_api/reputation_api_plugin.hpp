...
#include <worth/plugins/reputation/reputation_plugin.hpp>
#include <worth/plugins/json_rpc/json_rpc_plugin.hpp>

#include <appbase/application.hpp>

#define WORTH_REPUTATION_API_PLUGIN_NAME "reputation_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (worth::plugins::reputation::reputation_plugin)
   ...
   static const std::string& name() { static std::string name = WORTH_REPUTATION_API_PLUGIN_NAME; return name; }
