...
#define WORTH_FOLLOW_API_PLUGIN_NAME "follow_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (worth::plugins::follow::follow_plugin)
   ...
   static const std::string& name() { static std::string name = WORTH_FOLLOW_API_PLUGIN_NAME; return name; }
