...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v, chain_id_type c_id )
      :blockchain_version( bc_v ), worth_revision( s_v ), fc_revision( fc_v ), chain_id( c_id ) {}
...
typedef list_object_args_type list_wbd_conversion_requests_args;

struct list_wbd_conversion_requests_return
{
   vector< api_convert_request_object > requests;
};


struct find_wbd_conversion_requests_args
{
   account_name_type account;
};

typedef list_wbd_conversion_requests_return find_wbd_conversion_requests_return;
...
typedef list_object_args_type list_wmt_contributions_args;

struct list_wmt_contributions_return
{
   vector< wmt_contribution_object > contributions;
};

struct find_wmt_contributions_args
{
   vector< std::pair< asset_symbol_type, account_name_type > > symbol_contributors;
};

typedef list_wmt_contributions_return find_wmt_contributions_return;

typedef list_object_args_type list_wmt_token_emissions_args;

typedef list_object_args_type list_wmt_tokens_args;

struct list_wmt_tokens_return
{
   vector< api_wmt_token_object > tokens;
};

struct find_wmt_tokens_args
{
   vector< asset_symbol_type > symbols;
   bool ignore_precision = false;
};

typedef list_wmt_tokens_return find_wmt_tokens_return;


typedef list_object_args_type list_wmt_token_emissions_args;

struct list_wmt_token_emissions_return
{
   vector< wmt_token_emissions_object > token_emissions;
};

struct find_wmt_token_emissions_args
{
   asset_symbol_type asset_symbol;
};

typedef list_wmt_token_emissions_return find_wmt_token_emissions_return;

#endif

} } } // worth::database_api

FC_REFLECT( worth::plugins::database_api::get_version_return,
            (blockchain_version)(worth_revision)(fc_revision)(chain_id) )

FC_REFLECT_ENUM( worth::plugins::database_api::sort_order_type,
   (by_name)
   (by_proxy)
   (by_next_vesting_withdrawal)
   (by_account)
...
FC_REFLECT_ENUM( worth::plugins::database_api::order_direction_type,
  (ascending)
  (descending) )

FC_REFLECT( worth::plugins::database_api::list_object_args_type,
   (start)(limit)(order) )

FC_REFLECT( worth::plugins::database_api::get_reward_funds_return,
   (funds) )

FC_REFLECT( worth::plugins::database_api::list_witnesses_return,
   (witnesses) )

FC_REFLECT( worth::plugins::database_api::find_witnesses_args,
   (owners) )

FC_REFLECT( worth::plugins::database_api::list_witness_votes_return,
   (votes) )

FC_REFLECT( worth::plugins::database_api::get_active_witnesses_return,
   (witnesses) )

FC_REFLECT( worth::plugins::database_api::list_accounts_return,
   (accounts) )

FC_REFLECT( worth::plugins::database_api::find_accounts_args,
   (accounts) )

FC_REFLECT( worth::plugins::database_api::list_owner_histories_args,
   (start)(limit) )

FC_REFLECT( worth::plugins::database_api::list_owner_histories_return,
   (owner_auths) )

FC_REFLECT( worth::plugins::database_api::find_owner_histories_args,
   (owner) )

FC_REFLECT( worth::plugins::database_api::list_account_recovery_requests_return,
   (requests) )

FC_REFLECT( worth::plugins::database_api::find_account_recovery_requests_args,
   (accounts) )

FC_REFLECT(
   worth::plugins::database_api::list_change_recovery_account_requests_return,
   (requests) )

FC_REFLECT( worth::plugins::database_api::find_change_recovery_account_requests_args,
   (accounts) )

FC_REFLECT( worth::plugins::database_api::list_escrows_return,
   (escrows) )

FC_REFLECT( worth::plugins::database_api::find_escrows_args,
   (from) )

FC_REFLECT( worth::plugins::database_api::list_withdraw_vesting_routes_return,
   (routes) )

FC_REFLECT( worth::plugins::database_api::find_withdraw_vesting_routes_args,
   (account)(order) )

FC_REFLECT( worth::plugins::database_api::list_savings_withdrawals_return,
   (withdrawals) )

FC_REFLECT( worth::plugins::database_api::find_savings_withdrawals_args,
   (account) )

FC_REFLECT( worth::plugins::database_api::list_vesting_delegations_return,
   (delegations) )

FC_REFLECT( worth::plugins::database_api::find_vesting_delegations_args,
   (account) )

FC_REFLECT( worth::plugins::database_api::list_vesting_delegation_expirations_return,
   (delegations) )

FC_REFLECT( worth::plugins::database_api::find_vesting_delegation_expirations_args,
   (account) )

FC_REFLECT( worth::plugins::database_api::list_wbd_conversion_requests_return,
   (requests) )

FC_REFLECT( worth::plugins::database_api::find_wbd_conversion_requests_args,
   (account) )

FC_REFLECT( worth::plugins::database_api::list_decline_voting_rights_requests_return,
   (requests) )

FC_REFLECT( worth::plugins::database_api::find_decline_voting_rights_requests_args,
   (accounts) )

FC_REFLECT( worth::plugins::database_api::list_comments_return,
   (comments) )

FC_REFLECT( worth::plugins::database_api::find_comments_args,
   (comments) )

FC_REFLECT( worth::plugins::database_api::list_votes_return,
   (votes) )

FC_REFLECT( worth::plugins::database_api::find_votes_args,
   (author)(permlink) )

FC_REFLECT( worth::plugins::database_api::list_limit_orders_return,
   (orders) )

FC_REFLECT( worth::plugins::database_api::find_limit_orders_args,
   (account) )

FC_REFLECT( worth::plugins::database_api::get_order_book_args,
   (limit) )

FC_REFLECT( worth::plugins::database_api::list_proposals_args,
   (start)(limit)(order)(order_direction)(status) )

FC_REFLECT( worth::plugins::database_api::list_proposals_return,
   (proposals) )

FC_REFLECT( worth::plugins::database_api::find_proposals_args,
   (proposal_ids) )

FC_REFLECT( worth::plugins::database_api::list_proposal_votes_return,
   (proposal_votes) )

FC_REFLECT( worth::plugins::database_api::get_transaction_hex_args,
   (trx) )

FC_REFLECT( worth::plugins::database_api::get_transaction_hex_return,
   (hex) )

FC_REFLECT( worth::plugins::database_api::get_required_signatures_args,
   (trx)
   (available_keys) )

FC_REFLECT( worth::plugins::database_api::get_required_signatures_return,
   (keys) )

FC_REFLECT( worth::plugins::database_api::get_potential_signatures_args,
   (trx) )

FC_REFLECT( worth::plugins::database_api::verify_authority_args,
   (trx) )

FC_REFLECT( worth::plugins::database_api::verify_authority_return,
   (valid) )

FC_REFLECT( worth::plugins::database_api::verify_account_authority_args,
   (account)
   (signers) )

FC_REFLECT( worth::plugins::database_api::verify_signatures_args,
   (hash)
   (signatures)
   (required_owner)
   (required_active)
...
FC_REFLECT( worth::plugins::database_api::verify_signatures_return,
   (valid) )

#ifdef WORTHEUM_ENABLE_WMT

FC_REFLECT( worth::plugins::database_api::get_nai_pool_return,
   (nai_pool) )

FC_REFLECT( worth::plugins::database_api::list_wmt_contributions_return,
   (contributions) )

FC_REFLECT( worth::plugins::database_api::find_wmt_contributions_args,
   (symbol_contributors) )

FC_REFLECT( worth::plugins::database_api::list_wmt_tokens_return,
   (tokens) )

FC_REFLECT( worth::plugins::database_api::find_wmt_tokens_args,
   (symbols)(ignore_precision) )

FC_REFLECT( worth::plugins::database_api::list_wmt_token_emissions_return,
   (token_emissions) )

FC_REFLECT( worth::plugins::database_api::find_wmt_token_emissions_args,
   (asset_symbol) )
