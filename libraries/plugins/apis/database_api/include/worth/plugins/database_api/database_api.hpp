...
#include <worth/plugins/database_api/database_api_args.hpp>
   ...
   public:
      ...
      DECLARE_API(
         ...
         */
          ...
          * using the existing authority structures in Wortheum
          */
         (verify_signatures)

#ifdef WORTHEUM_ENABLE_WMT
         /**
         * @return array of Numeric Asset Identifier (NAI) available to be used for new WMT to be created.
         */
         (get_nai_pool)
