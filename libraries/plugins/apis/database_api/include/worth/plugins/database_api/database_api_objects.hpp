...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_worth_dollars( o.percent_worth_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      savings_wbd_balance( a.savings_wbd_balance ),
      ...
      reward_wbd_balance( a.reward_wbd_balance ),
      reward_worth_balance( a.reward_worth_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_worth( a.reward_vesting_worth ),
      ...
      pending_claimed_accounts( a.pending_claimed_accounts )
   {
      ...
      const auto& by_control_account_index = db.get_index<wmt_token_index>().indices().get<by_control_account>();
      auto wmt_obj_itr = by_control_account_index.find( name );
      is_wmt = wmt_obj_itr != by_control_account_index.end();
#endif
   }
   ...
   asset             reward_wbd_balance;
   asset             reward_worth_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_worth;
...
struct api_wmt_token_object
{
   api_wmt_token_object( const wmt_token_object& token, const database& db ) : token( token )
   {
      const wmt_ico_object* ico = db.find< chain::wmt_ico_object, chain::by_symbol >( token.liquid_symbol );
      if ( ico != nullptr )
         this->ico = *ico;
   }

   wmt_token_object                token;
   fc::optional< wmt_ico_object >  ico;
};
...
{
   price                order_price;
   double               real_price; // dollars per worth
   share_type           worth;
   share_type           wbd;
...
FC_REFLECT( worth::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( worth::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( worth::plugins::database_api::api_account_object,
...
FC_REFLECT( worth::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( worth::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( worth::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( worth::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( worth::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( worth::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( worth::plugins::database_api::api_signed_block_object, (worth::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( worth::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( worth::plugins::database_api::api_wmt_token_object,
   (token)
   (ico)
)
...
FC_REFLECT_ENUM( worth::plugins::database_api::proposal_status,
                  (all)
                  (inactive)
                  (active)
                  (expired)
...
FC_REFLECT( worth::plugins::database_api::api_proposal_object,
            (id)
            (proposal_id)
            (creator)
            (receiver)
...
FC_REFLECT( worth::plugins::database_api::api_proposal_vote_object,
            (id)
            (voter)
            (proposal)
          )

FC_REFLECT( worth::plugins::database_api::order, (order_price)(real_price)(worth)(wbd)(created) );

FC_REFLECT( worth::plugins::database_api::order_book, (asks)(bids) );
