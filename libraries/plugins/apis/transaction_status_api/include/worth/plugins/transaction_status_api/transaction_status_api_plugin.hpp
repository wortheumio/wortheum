...
#define WORTH_TRANSACTION_STATUS_API_PLUGIN_NAME "transaction_status_api"
...
class transaction_status_api_plugin : public appbase::plugin< transaction_status_api_plugin >
{
   public:
      ...
      APPBASE_PLUGIN_REQUIRES(
         ...
         (worth::plugins::transaction_status::transaction_status_plugin)
      )

      static const std::string& name() { static std::string name = WORTH_TRANSACTION_STATUS_API_PLUGIN_NAME; return name; }
