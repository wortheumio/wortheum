...
#define WORTH_WEBSERVER_PLUGIN_NAME "webserver"

namespace worth { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WORTH_WEBSERVER_PLUGIN_NAME; return name; }
