...
#ifndef WORTH_WITNESS_SPACE_ID
#define WORTH_WITNESS_SPACE_ID 19
#endif
...
{
   witness_custom_op_object_type          = ( WORTH_WITNESS_SPACE_ID << 8 )
};
...
FC_REFLECT( worth::plugins::witness::witness_custom_op_object,
   (id)
   (account)
   (count)
   )
CHAINBASE_SET_INDEX_TYPE( worth::plugins::witness::witness_custom_op_object, worth::plugins::witness::witness_custom_op_index )
