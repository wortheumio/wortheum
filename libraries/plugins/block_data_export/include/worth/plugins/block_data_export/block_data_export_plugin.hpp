...
#define WORTH_BLOCK_DATA_EXPORT_PLUGIN_NAME "block_data_export"
...
class block_data_export_plugin : public appbase::plugin< block_data_export_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WORTH_BLOCK_DATA_EXPORT_PLUGIN_NAME; return name; }
