...
namespace worth { namespace plugins { namespace block_data_export {
...
FC_REFLECT( worth::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace worth { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // worth::plugins::block_data_export
