...
#define WORTH_TRANSACTION_STATUS_PLUGIN_NAME "transaction_status"
...
class transaction_status_plugin : public appbase::plugin< transaction_status_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WORTH_TRANSACTION_STATUS_PLUGIN_NAME; return name; }
