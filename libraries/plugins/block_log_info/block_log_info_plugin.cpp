...
#include <worth/plugins/block_log_info/block_log_info_plugin.hpp>
#include <worth/plugins/block_log_info/block_log_info_objects.hpp>
...
void block_log_info_plugin::plugin_initialize( const boost::program_options::variables_map& options )
{
   ...
   try
   {
      ...
      WORTH_ADD_PLUGIN_INDEX(db, block_log_hash_state_index);
      WORTH_ADD_PLUGIN_INDEX(db, block_log_pending_message_index);
