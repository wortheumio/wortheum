...
// time.
//
#ifndef WORTH_TAG_SPACE_ID
#define WORTH_TAG_SPACE_ID 5
#endif

#define WORTH_TAGS_PLUGIN_NAME "tags"
...
enum
{
   tag_object_type              = ( WORTH_TAG_SPACE_ID << 8 ),
   tag_stats_object_type        = ( WORTH_TAG_SPACE_ID << 8 ) + 1,
   peer_stats_object_type       = ( WORTH_TAG_SPACE_ID << 8 ) + 2,
   author_tag_stats_object_type = ( WORTH_TAG_SPACE_ID << 8 ) + 3
};
...
class tag_stats_object : public object< tag_stats_object_type, tag_stats_object >
{
   public:
      ...
      tag_name_type     tag;
      asset             total_payout = asset( 0, WBD_SYMBOL );
      int32_t           net_votes = 0;
...
class author_tag_stats_object : public object< author_tag_stats_object_type, author_tag_stats_object >
{
   public:
      ...
      account_id_type author;
      tag_name_type   tag;
      asset           total_rewards = asset( 0, WBD_SYMBOL );
...
class tags_plugin : public plugin< tags_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WORTH_TAGS_PLUGIN_NAME; return name; }
...
FC_REFLECT( worth::plugins::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
CHAINBASE_SET_INDEX_TYPE( worth::plugins::tags::tag_object, worth::plugins::tags::tag_index )

FC_REFLECT( worth::plugins::tags::tag_stats_object,
   (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending) );
CHAINBASE_SET_INDEX_TYPE( worth::plugins::tags::tag_stats_object, worth::plugins::tags::tag_stats_index )

FC_REFLECT( worth::plugins::tags::comment_metadata, (tags) );

FC_REFLECT( worth::plugins::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( worth::plugins::tags::author_tag_stats_object, worth::plugins::tags::author_tag_stats_index )
