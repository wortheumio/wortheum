...
#ifndef WORTH_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID
#define WORTH_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID 15
#endif
...
{
   volatile_operation_object_type = ( WORTH_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID << 8 )
};

class volatile_operation_object : public object< volatile_operation_object_type, volatile_operation_object >
{
   WORTH_STD_ALLOCATOR_CONSTRUCTOR( volatile_operation_object )
...
} } } // worth::plugins::account_history_rocksdb

FC_REFLECT( worth::plugins::account_history_rocksdb::volatile_operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op)(impacted) )
CHAINBASE_SET_INDEX_TYPE( worth::plugins::account_history_rocksdb::volatile_operation_object, worth::plugins::account_history_rocksdb::volatile_operation_index )

FC_REFLECT( worth::plugins::account_history_rocksdb::rocksdb_operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
