...
struct private_message_operation : public worth::protocol::base_operation
{
...
FC_REFLECT( worth::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

WORTH_DECLARE_OPERATION_TYPE( worth::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( worth::private_message::private_message_plugin_operation )
