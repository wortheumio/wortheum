...
#include <worth/plugins/block_info/block_info_api.hpp>
#include <worth/plugins/block_info/block_info_plugin.hpp>
...
{
   public:
      block_info_api_impl( worth::app::application& _app );

      std::shared_ptr< worth::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( worth::app::application& _app ) : app( _app )
{}

std::shared_ptr< worth::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const worth::app::api_context& ctx )
{
