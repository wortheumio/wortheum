...
#include <worth/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const worth::app::api_context& ctx );
...
FC_REFLECT( worth::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( worth::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
