...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( worth::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( WORTH_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const worth::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->worth_transferred                      += b.worth_transferred;
   this->wbd_transferred                        += b.wbd_transferred;
   this->wbd_paid_as_interest                   += b.wbd_paid_as_interest;
   ...
   this->wbd_paid_to_authors                    += b.wbd_paid_to_authors;
   ...
   this->worth_vested                           += b.worth_vested;
   ...
   this->wbd_conversion_requests_created        += b.wbd_conversion_requests_created;
   this->wbd_to_be_converted                    += b.wbd_to_be_converted;
   this->wbd_conversion_requests_filled         += b.wbd_conversion_requests_filled;
   this->worth_converted                        += b.worth_converted;
