...
#include <worth/protocol/sign_state.hpp>

#include <worth/chain/account_object.hpp>
#include <worth/chain/database.hpp>

#include <worth/plugins/auth_util/auth_util_api.hpp>
#include <worth/plugins/auth_util/auth_util_plugin.hpp>
...
{
   public:
      auth_util_api_impl( worth::app::application& _app );
      void check_authority_signature( const check_authority_signature_params& args, check_authority_signature_result& result );

      std::shared_ptr< worth::plugin::auth_util::auth_util_plugin > get_plugin();

      worth::app::application& app;
};

auth_util_api_impl::auth_util_api_impl( worth::app::application& _app ) : app( _app )
{}

std::shared_ptr< worth::plugin::auth_util::auth_util_plugin > auth_util_api_impl::get_plugin()
{
...
auth_util_api::auth_util_api( const worth::app::api_context& ctx )
{
