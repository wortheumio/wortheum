...
#include <worth/plugins/raw_block/raw_block_api.hpp>
#include <worth/plugins/raw_block/raw_block_plugin.hpp>
...
{
   public:
      raw_block_api_impl( worth::app::application& _app );

      std::shared_ptr< worth::plugin::raw_block::raw_block_plugin > get_plugin();

      worth::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( worth::app::application& _app ) : app( _app )
{}

std::shared_ptr< worth::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const worth::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< worth::chain::database > db = my->app.chain_database();
