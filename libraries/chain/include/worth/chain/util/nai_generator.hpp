...
public:
   ...
   //    [0 : 09,999,999] and 90 million available for WMT creators [10,000,000 : 99,999,999]
   ...
   // 6. 45 million WMTs await for their creators.
   static asset_symbol_type generate( uint32_t seed )
   {
      asset_symbol_type new_symbol;
      uint32_t nai = ( hasher::hash( seed ) % ( ( WMT_MAX_NAI + 1 ) - WMT_MIN_NON_RESERVED_NAI ) ) + WMT_MIN_NON_RESERVED_NAI;
      nai &= ~1;
