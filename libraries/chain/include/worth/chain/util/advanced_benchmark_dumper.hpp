...
FC_REFLECT( worth::chain::util::advanced_benchmark_dumper::item, (op_name)(time) )
FC_REFLECT( worth::chain::util::advanced_benchmark_dumper::ritem, (op_name)(time) )

FC_REFLECT( worth::chain::util::advanced_benchmark_dumper::total_info< std::set< worth::chain::util::advanced_benchmark_dumper::item > >, (total_time)(items) )
FC_REFLECT( worth::chain::util::advanced_benchmark_dumper::total_info< std::multiset< worth::chain::util::advanced_benchmark_dumper::ritem > >, (total_time)(items) )
