...
struct wps_removing_reducer
{
   ...
   wps_removing_reducer( int16_t _threshold = -1 )
...
class wps_helper
{
   private:
      ...
      template<   typename ByProposalType,
                  ...
                  >
      static ProposalObjectIterator checker( const ProposalObjectIterator& proposal, ProposalIndex& proposalIndex, wps_removing_reducer& obj_perf )
      {
         obj_perf.done = false;
   ...
   public:
      ...
      static ProposalObjectIterator remove_proposal( ProposalObjectIterator& proposal,
                  ProposalIndex& proposalIndex, VotesIndex& votesIndex, const ByVoterIdx& byVoterIdx, wps_removing_reducer& obj_perf )
      {
