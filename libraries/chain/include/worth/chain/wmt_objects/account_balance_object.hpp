...
/**
 * Class responsible for holding regular (i.e. non-reward) balance of WMT for given account.
...
{
   WORTH_STD_ALLOCATOR_CONSTRUCTOR( account_regular_balance_object );
...
public:   
   ...
   asset               liquid;   /// 'balance' for WORTH
   ...
   {
      // There's no need to store vesting value (in liquid WMT variant) in regular balance.
...
/**
 * Class responsible for holding reward balance of WMT for given account.
...
{
   WORTH_STD_ALLOCATOR_CONSTRUCTOR( account_rewards_balance_object );
...
public:   
   ...
   /// Name of the account, the balance is held for.
   account_name_type   owner;
   asset               pending_liquid;          /// 'reward_worth_balance' for pending WORTH
   asset               pending_vesting_shares;  /// 'reward_vesting_balance' for pending VESTS
   asset               pending_vesting_value;   /// 'reward_vesting_worth' for pending VESTS
...
FC_REFLECT( worth::chain::account_regular_balance_object,
   (id)
   (owner)
   (liquid)
   (vesting)
...
FC_REFLECT( worth::chain::account_rewards_balance_object,
   (id)
   (owner)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( worth::chain::account_regular_balance_object, worth::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( worth::chain::account_rewards_balance_object, worth::chain::account_rewards_balance_index )
