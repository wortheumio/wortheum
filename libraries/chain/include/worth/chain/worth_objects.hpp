...
namespace worth { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert wbd to worth
    */
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( savings_withdraw_object )
    ...
    *  1000 WORTH or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         int64_t           worth_volume = 0;
         int64_t           wbd_volume = 0;
         uint128_t         weight = 0;
         ...
         {
            return worth_volume * wbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(worth_volume,wbd_volume) * is_positive();
         }
         ...
         {
            return ( worth_volume > 0 && wbd_volume > 0 ) ? 1 : 0;
         }
   };
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( feed_history_object )
...
template<> struct is_static_length< worth::chain::convert_request_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::escrow_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::liquidity_reward_balance_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::limit_order_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::withdraw_vesting_route_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::decline_voting_rights_request_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::reward_fund_object > : public boost::true_type {};
...
FC_REFLECT( worth::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::limit_order_object, worth::chain::limit_order_index )

FC_REFLECT( worth::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::feed_history_object, worth::chain::feed_history_index )

FC_REFLECT( worth::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::convert_request_object, worth::chain::convert_request_index )

FC_REFLECT( worth::chain::liquidity_reward_balance_object,
             (id)(owner)(worth_volume)(wbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::liquidity_reward_balance_object, worth::chain::liquidity_reward_balance_index )

FC_REFLECT( worth::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::withdraw_vesting_route_object, worth::chain::withdraw_vesting_route_index )

FC_REFLECT( worth::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::savings_withdraw_object, worth::chain::savings_withdraw_index )

FC_REFLECT( worth::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (wbd_balance)(worth_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::escrow_object, worth::chain::escrow_index )

FC_REFLECT( worth::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::decline_voting_rights_request_object, worth::chain::decline_voting_rights_request_index )

FC_REFLECT( worth::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( worth::chain::reward_fund_object, worth::chain::reward_fund_index )
