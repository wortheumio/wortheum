...
namespace worth { namespace chain {
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( transaction_object )
...
FC_REFLECT( worth::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::transaction_object, worth::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<worth::chain::transaction_index>
   {
   public:
      typedef worth::chain::transaction_index IndexType;
      typedef typename worth::chain::transaction_object::t_packed_trx t_packed_trx;
