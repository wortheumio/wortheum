...
namespace worth { namespace chain {
   ...
   using worth::protocol::weight_type;
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( shared_authority )
...
FC_REFLECT_TYPENAME( worth::chain::shared_authority::account_authority_map)
FC_REFLECT( worth::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
