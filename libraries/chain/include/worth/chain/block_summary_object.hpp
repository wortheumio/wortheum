...
template<> struct is_static_length< worth::chain::block_summary_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( worth::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::block_summary_object, worth::chain::block_summary_index )
