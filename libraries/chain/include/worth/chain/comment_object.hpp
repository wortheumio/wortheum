...
namespace worth { namespace chain {
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( comment_object )
      ...
      public:
         ...
         /** tracks the total payout this comment has received over time, measured in WBD */
         asset             total_payout_value = asset(0, WBD_SYMBOL);
         asset             curator_payout_value = asset(0, WBD_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, WBD_SYMBOL );
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( comment_content_object )
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( comment_vote_object )
...
template<> struct is_static_length< worth::chain::comment_vote_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( worth::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( worth::chain::comment_object, worth::chain::comment_index )

FC_REFLECT( worth::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::comment_content_object, worth::chain::comment_content_index )

FC_REFLECT( worth::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( worth::chain::comment_vote_object, worth::chain::comment_vote_index )

namespace helpers
{
   using worth::chain::shared_string;

   template <>
   class index_statistic_provider<worth::chain::comment_index>
   {
   public:
      typedef worth::chain::comment_index IndexType;
      typedef typename worth::chain::comment_object::t_beneficiaries t_beneficiaries;
#ifdef WORTHEUM_ENABLE_WMT
      typedef typename worth::chain::comment_object::t_votable_assets t_votable_assets;
#endif
   ...
   template <>
   class index_statistic_provider<worth::chain::comment_content_index>
   {
   public:
      typedef worth::chain::comment_content_index IndexType;
