...
namespace worth { namespace chain {
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( WORTH_MIN_ACCOUNT_CREATION_FEE, WORTH_SYMBOL );
       ...
       * Scaled so that WORTH_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << WORTH_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   {
      WORTH_STD_ALLOCATOR_CONSTRUCTOR( witness_object )
      ...
      public:
         ...
         /**
          * This field represents the Wortheum blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, WORTH_MAX_WITNESSES >             current_shuffled_witnesses;
...
template<> struct is_static_length< worth::chain::witness_vote_object > : public boost::true_type {};
template<> struct is_static_length< worth::chain::witness_schedule_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT_ENUM( worth::chain::witness_object::witness_schedule_type, (elected)(timeshare)(miner)(none) )

FC_REFLECT( worth::chain::chain_properties,
...
FC_REFLECT( worth::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( worth::chain::witness_object, worth::chain::witness_index )

FC_REFLECT( worth::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( worth::chain::witness_vote_object, worth::chain::witness_vote_index )

FC_REFLECT( worth::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( worth::chain::witness_schedule_object, worth::chain::witness_schedule_index )
