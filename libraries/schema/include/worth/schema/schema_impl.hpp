...
#define WORTH_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
WORTH_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define WORTH_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define WORTH_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define WORTH_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
WORTH_DECLARE_SCHEMA_CLASS( false, false )
WORTH_DECLARE_SCHEMA_CLASS(  true, false )
WORTH_DECLARE_SCHEMA_CLASS(  true,  true )
