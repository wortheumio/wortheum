...
operation_tests      // Unit Tests of Wortheum operations
operation_time_tests // Tests of Wortheum operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_WORTHEUM_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
