...
When configuring MIRA it is important to consider the normal memory usage of `worths`. Regardless of the MIRA configuration, `worths` will tend to use roughly 5.5GiB of memory.
