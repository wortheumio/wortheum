...
while (( "$#" )); do
   case "$1" in
      ...
      -p|--stats-dump-period)
         ...
         ;;
      -h|--help)
         echo "Specify data directory with '--data-dir' (Default is ~/.worths)"
         echo "Specify worths directory with '--worths-dir' (Default is ../..)"
...
cd "$WORTHS_DIR/libraries/vendor/rocksdb/tools/advisor"
