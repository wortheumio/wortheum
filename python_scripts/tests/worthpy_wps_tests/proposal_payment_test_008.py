...
MAIN_LOG_PATH = "./wps_proposal_payment_008.log"
...
if __name__ == '__main__':
    ...
    try:
        if node is None or node.is_running():
            ...
            proposals.append({'creator' : 'tester001', 'receiver' : 'worth.dao', 'start_date' : start_date, 'end_date' : end_date, 'daily_pay' : '96.000 TBD'})
