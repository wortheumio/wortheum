...
# local imports
from worthsebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a worths debug node on an existing chain, trigger a hardfork' \
...
def run_worths_tests( debug_node ):
   from worthapi.worthnoderpc import WorthNodeRPC
   ...
   try:
      ...
      rpc = WorthNodeRPC( 'ws://127.0.0.1:8095', '', '' )
